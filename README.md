...
| :--- | :--- | :--- |
| **Frontend UI** | [http://localhost:5173](http://localhost:5173) | Main React application (Vite) |
| **Local API Gateway** | [http://localhost:80/api/v1](http://localhost:80/api/v1) | Nginx Reverse Proxy entry point |
| **Direct Backend API** | [http://localhost:8080](http://localhost:8080) | Spring Boot REST endpoints |
